...
//     MemberOwner, Renderer, RendererElementType, RendererNodeId, SoloView, View, ViewCtx,
//     ViewMember,
// };

// impl<T> RendererElementType<R> for BevyWrapper<T>
// where
//     T: ElementType,
// {
...
//
// #[derive(Clone)]
// pub struct BevyElement<R, E, VM>(pub Element<R, R::Wrapper<E>, VM>)
// where
//     R: Renderer,
//     R::Wrapper<E>: RendererElementType<R>,
//     VM: ViewMember<R>;
//
// impl<R, E, VM> BevyElement<R, E, VM>
// where
//     R: Renderer,
//     R::Wrapper<E>: RendererElementType<R>,
//     VM: ViewMember<R>,
// {
//     pub fn children<CV>(self, children: CV) -> BevyElementChildren<R, E, VM, CV::View>
//     where
//         CV: IntoView<R>,
//     {
...
// pub type BevyElementChildren<R, E, VM, CV> = ElementViewChildren<BevyElement<R, E, VM>, CV, R>;

use core::fmt::Debug;
use core::hash::Hash;
use core::marker::PhantomData;

use rxy_core::{ElementView, IntoView, MaybeSend, MemberOwner, NodeTree, Renderer, RendererElementType, RendererNodeId, SoloView, View, ViewCtx, ViewKey, ViewMember, ViewMemberCtx};
