// use crate::{Renderer, RendererNodeId, RendererWorld};
// use crate::element::{AttrIndex, ElementAttr};


// impl<R, F, VM> ViewAttr<R> for rxy_core::Reactive<F, VM>
// where
//     R: Renderer,
//     RendererWorld<R>: ElementNodeTree<R>,
//     F: Fn() -> VM + MaybeSend + 'static,
//     VM: ViewAttr<R> + MaybeSend,
// {
//     type EA = VM::EA;
// }
...
// pub trait IntoViewAttrMember<R, EA>
// where
//     R: Renderer,
//     EA: ElementAttr<R>,
// {
//     type Attr: ViewMember<R> + IntoViewAttrMember<R, EA>;
//     type OtherAttr<OEA: ElementAttr<R, Value = EA::Value>>: ViewMember<R>
//         + IntoViewAttrMember<R, OEA>;
//
//     fn into_attr(self) -> Self::Attr;
//
//     fn into_other_attr<OEA: ElementAttr<R, Value = EA::Value>>(self) -> Self::OtherAttr<OEA>;
// }
//
...
// //     type Attr = Self;
// //
// //     type OtherAttr<OEA: ElementAttr<Value = <EA>::Value>> = ViewAttr<OEA>;
// //
// //     fn into_attr(self) -> Self::Attr {
// //         self
// //     }
// //
// //     fn into_other_attr<OEA: ElementAttr<Value = <EA>::Value>>(self) -> Self::OtherAttr<OEA> {
// //         ViewAttr(self.0)
// //     }
// // }
//
// impl<R, EA, T> IntoViewAttrMember<R, EA> for T
// where
//     EA: ElementAttr<R>,
...
//
//     type OtherAttr<OEA: ElementAttr<Value = <EA>::Value>> = Option<T::OtherAttr<OEA>>;
//
//     fn into_attr(self) -> Self::Attr {
...
//
//     type OtherAttr<OEA: ElementAttr<Value = <EA>::Value>> =
...
//     type Attr = Self;
//
//     type OtherAttr<OEA: ElementAttr<Value = <EA>::Value>> = Self;
//
//     fn into_attr(self) -> Self::Attr {
//         self
//     }
