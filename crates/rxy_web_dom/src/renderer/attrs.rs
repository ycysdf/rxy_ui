    ...
    ($name:ident;$index_start:expr;$($attr:ident)*) => {
        ...
        paste::paste!{
            pub trait [<$name ViewBuilder>]: rxy_core::MemberOwner<$crate::WebRenderer> + Sized {
                ...
                $(
                    fn $attr<T>(self, value: impl rxy_core::IntoViewMember<$crate::WebRenderer, T>) -> Self::AddMember<T>
                    where
...
impl ElementAttr<WebRenderer> for class {
    ...
    fn update_value(
        ...
        _node_id: RendererNodeId<WebRenderer>,
