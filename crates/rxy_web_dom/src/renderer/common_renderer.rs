...
use rxy_core::{define_common_view_fns, ElementAttrMember, ElementSoloView, MapToAttrMarker, MemberOwner, ViewMember, ViewMemberOrigin, XNest};

define_common_view_fns!(WebRenderer);

impl CommonRenderer for WebRenderer {
    type DivView = WebElement<ElementTypeDiv, ()>;
    type SpanView<T: ViewMember<Self>+ViewMemberOrigin<Self, Origin = ElementAttrViewMember<Self, Self::SpanContentEA>>> = WebElement<ElementTypeSpan, (T,)>;
