...
use bevy::prelude::{Camera2dBundle, Color, Commands, Startup};
use rxy_bevy::{BevyRenderer, RxyPlugin, RxyUiCommandExt};
use rxy_bevy::prelude::div;
use rxy_bevy_style::RxyStyleSheetPlugin;
use rxy_core::{IntoView, rx};
use rxy_core::prelude::x;
use rxy_bevy_style::ElementStyleExt;
use rxy_bevy::all_attrs::CommonAttrsViewBuilder;
...
fn sample() -> impl IntoView<BevyRenderer> {
    div()
